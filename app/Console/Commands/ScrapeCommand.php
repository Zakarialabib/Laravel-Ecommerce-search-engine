...
class ScrapeCommand extends Command
{
     ...
     */
    protected string $signature = 'scrape:devices';

    /**
     * The console command description.
     */
    protected string $description = 'This function scrapes mobile phone manufacturers and their devices from gsmarena.com';
