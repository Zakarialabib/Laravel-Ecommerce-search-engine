                ...
                <form wire:submit.prevent="submit" class="pt-3">
                    ...
                    <div class="w-full mb-4">
                        @if ($banner_image != null)
                            <img src="{{ asset('uploads/' . $banner_image) }}" loading="lazy"
                        ...
                        <x-input type="file" id="banner_image" wire:model="banner_image" />
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <div class="lg:w-1/3 sm:w-1/2 px-2 mt-5 {{ $errors->has('email') ? 'is-invalid' : '' }}">
                            ...
                            <input type="email" name="email" id="email" disabled wire:model="email" />
                    ...
                    <div class="lg:w-1/3 sm:w-1/2 px-2 mt-5 {{ $errors->has('company_name') ? 'is-invalid' : '' }}">
                        ...
                        <input type="text" name="company_name" id="company_name" wire:model="company_name" />
