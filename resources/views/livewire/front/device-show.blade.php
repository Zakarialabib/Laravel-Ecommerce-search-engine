    ...
    <div class="my-5">
        <div itemtype="https://schema.org/Product" itemscope>
                            ...
                            <div class="mb-5">
                                ...
                                <div class="mb-2">
                                    <table class="table-auto">
                                        <thead>
                                            <tr>
                                                <th class="px-4 py-2">{{ __('Store Name') }}</th>
                                                <th class="px-4 py-2">{{ __('Price') }}</th>
                                                <th class="px-4 py-2">{{ __('Store URL') }}</th>
                                            </tr>
                                        </thead>
                                        <tbody>
            ...
            <div x-data="{ activeTab: 'description' }" class="mx-auto px-4 border bg-white shadow-xl">
                <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 mb-10">
                    ...
                    <div
                        class="inline-block py-6 px-10 text-left font-bold font-heading text-gray-500 uppercase border-b-2 border-gray-100 hover:border-gray-500 focus:outline-none focus:border-gray-500">
                        <button @click="activeTab = 'brands'" :class="activeTab === 'brands' ? 'text-move-400' : ''">
                            {{ __('Product Brand') }}
                        </button>
                    </div>
                </div>
                ...
                <div x-show="activeTab === 'brands'" class="px-5 mb-10">
                    <div class="mb-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3 -mx-2 px-2">
                        {{-- @foreach ($brand_products as $device_model)
                                <x-product-card :product="$device_model" />
                            @endforeach --}}
                    </div>
                </div>
            </div>
        ...
        <div class="mx-auto px-4 mt-5">
            ...
            <div class="mb-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4 -mx-2 px-2">
                @foreach ($relatedProducts as $device_model)
                    <x-product-card :product="$device_model" />
                @endforeach
            </div>
        </div>
            ...
            <div class="px-6">
                <div class="w-full flex flex-col items-center justify-center mb-4">
                    <div class="heading text-center rtl:lg:text-right">
                        <h6 class="text-3xl font-bold sm:!leading-[50px] heading text-center rtl:lg:text-right !text-indigo-600">{{ __('Blog') }}</h6>
