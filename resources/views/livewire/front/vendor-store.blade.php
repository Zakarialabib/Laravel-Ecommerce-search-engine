                        ...
                        <div itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                                ...
                                <div>
                                    @if ($product->status == true)
                                        <a class="block text-center text-white font-bold font-heading py-2 px-4 rounded-md uppercase bg-move-400 hover:bg-move-200 transition cursor-pointer"
                                            href="https://{{ $product->url }}" target="_blank">
                                            {{ __('Buy directly') }}
                                        </a>
                                        {{-- product url www.hotech.ma --}}
                                        {{-- its giving this https://chrilia.com/catalog/www.hotech.ma --}}
                                    @else
                            ...
                            <ul class="my-4 flex gap-4">
                                <li class="text-gray-500 py-1">
                                    {{__('Vendor Catalog')}}
                                    <a href="{{ route('front.store-show', $product->store->slug) }}" target="_blank"
