                            ...
                            <x-table.td>
                                @if ($language['is_default'] == false)
                                    <x-button type="button" secondary
                                        wire:click="onSetDefault( {{ $language['id'] }} )">
                                ...
                                <x-button success type="button"
                                    wire:click="$emit('editLanguage', {{ $language['id'] }}) ">
                                    <i class="fas fa-edit"></i>
                                </x-button>

                                <x-button danger type="button"
                                    wire:click="$emit('deleteModal', {{ $language['id'] }})">
