            ...
            <div class="w-1/4 p-4 ">
                ...
                <div class="border border-gray-300 rounded-md shadow-sm py-2 w-full">
                    <form wire:submit.prevent="store" class="grid grid-cols gap-2 px-4">
                        ...
                        <!-- Menu Item Icon -->
                        <div class="w-full">
                            <x-label for="icon" :value="__('Menu Item Icon')" />
                            <x-input id="icon" class="block mt-1 w-full" type="text" name="icon"
                                wire:model.lazy="icon" placeholder="Enter icon name (e.g. fa-home)"> />
                                <small class="text-muted">Refer to the <a
                                        href="https://fontawesome.com/icons?d=gallery&p=2">Font Awesome website</a> for
                                    a list of available icons.</small>
                                <x-input-error :messages="$errors->get('icon')" for="icon" class="mt-2" />
                        </div>
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        ...
                                        <div class="w-full">
                                            ...
                                            <select id="type{{ $index }}" class="block mt-1 w-full"
                                                ...
                                                <option value="link" {{-- @if ($menu->type == 'link') selected @endif --}}>
                                                    {{ __('Link') }}
                                                </option>
                                                <option value="dropdown">
                                                    {{ __('Dropdown') }}</option>
                                        ...
                                        <div class="w-full">
                                            <x-label for="url" :value="__('URL')" />
                                            <x-input id="url{{ $index }}" class="block mt-1 w-full"
                                                type="text" name="url"
                                                wire:model.lazy="menus.{{ $index }}.url" />
                                            <x-input-error :messages="$errors->get('menu.url')" for="url" class="mt-2" />
                                        </div>
                                        ...
                                        <div class="w-full">
                                            <x-label for="icon" :value="__('Menu Item Icon')" />
                                            <x-input id="icon" class="block mt-1 w-full" type="text" name="icon"
                                                wire:model.lazy="menu.icon" placeholder="Enter icon name (e.g. fa-home)"> />
                                                <small class="text-muted">Refer to the <a
                                                        href="https://fontawesome.com/icons?d=gallery&p=2">Font Awesome website</a> for
                                                    a list of available icons.</small>
                                                <x-input-error :messages="$errors->get('menu.icon')" for="menu.icon" class="mt-2" />
                                        </div>
                                        ...
                                        <p class="float-right">
                                            <x-button type="button" wire:click="edit({{ $menu['id'] }})" primary>
                                                {{ __('Edit') }}
                                            </x-button>
                                        </p>
                                    </div>
