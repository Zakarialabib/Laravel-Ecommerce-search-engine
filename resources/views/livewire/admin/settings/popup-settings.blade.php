    ...
    <div class="container mx-auto my-5">
        ...
        @if ($popupModal)
            <x-modal wire:model="popupModal">
                ...
                <x-slot name="content">
                    <form wire:submit.prevent="{{ $popup === null ? 'create' : 'update(' . $popup->id . ')' }}">
                        ...
                        <div class="text-center py-4">
                            <!-- Create form -->
                            @if ($popup === null)
                                <x-button wire:click="create" type="button" primary>{{ __('Create') }}
                                </x-button>
                            @else
                                <x-button wire:click="update" type="button">{{ __('Update') }}</x-button>
                            @endif
                        </div>
