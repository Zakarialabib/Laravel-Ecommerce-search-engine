        ...
        <div class="flex">
            ...
            <div class="w-3/4 px-4">
                    ...
                    <form wire:submit.prevent="save" enctype="multipart/form-data">
                        ...
                        <div class="w-full flex flex-wrap">
                            ...
                            <div class="lg:w-1/2 sm:w-full mt-2 px-2">
                                ...
                                <x-input wire:model="company_phone" type="text" id="company_phone"
                                    name="company_phone" />
                            ...
                            <div class="w-full mt-2 px-2">
                                ...
                                <x-input wire:model="company_address" type="text" id="company_address"
                ...
                <div x-show="tab === 'maintenance'">
                    @livewire('admin.settings.maintenance-mode')
                </div>
                <div x-show="tab === 'mail'">
