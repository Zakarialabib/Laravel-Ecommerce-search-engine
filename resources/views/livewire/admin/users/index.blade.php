        ...
        <div class="flex flex-wrap items-center justify-between">
            <div class="mb-5 lg:mb-0">
                ...
                <div class="flex items-center">
                    ...
                    <a class="flex items-center text-sm" href="{{ route('admin.subcategories') }}">
                        <span class="inline-block mr-2">
    ...
    <x-card>
        <div class="flex flex-wrap justify-center">
            ...
            <div class="lg:w-1/2 md:w-1/2 sm:w-full my-2 my-md-0">
                ...
                <x-button success type="button" wire:click="filterRole('vendor')" class="ml-3">
                    Vendor
                </x-button>
                    ...
                    <x-table.tr wire:loading.class.delay="opacity-50" wire:key="row-{{ $user->id }}">
                        ...
                        <x-table.td>
                            <div class="flex justify-start space-x-2">
                                ...
                                <x-button danger type="button" wire:click="$emit('renewModal',{{ $user->id }})"
                                    wire:loading.attr="disabled">
                                    renew
                                </x-button>
                            </div>
