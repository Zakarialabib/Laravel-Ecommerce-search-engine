        ...
        <div class="grid gap-y-10 gap-x-4 py-14 sm:grid-cols-3 lg:grid-cols-5 lg:py-[100px]">
                ...
                <ul class="mt-12 flex items-center gap-8">
                    ...
                    <li>
                        <a href="{{ Helpers::settings('social_twitter') }}">
                            <svg width="23" height="18" viewBox="0 0 23 18" fill="none" xmlns="http://www.w3.org/2000/svg" class="transition hover:scale-110 hover:text-indigo-500">
                    ...
                    <li>
                        <a href="{{ Helpers::settings('social_instagram') }}">
                            <svg width="23" height="22" viewBox="0 0 23 22" fill="currentColor" xmlns="http://www.w3.org/2000/svg" class="transition hover:scale-110 hover:text-indigo-500">
            ...
            <div>
                <ul class="flex flex-col gap-3 font-bold">
                    ...
                    <li>
                        <a href="{{ route('front.categories')}}" class="inline-block transition hover:scale-110 hover:text-indigo-500">{{ $category->name }}</a>
                    </li>    
                    @endforeach
                </ul>
            </div>
    ...
    <div class="bg-gray-100 py-5 dark:border-t-2 dark:border-white/5 dark:bg-none">
        <div class="px-6">
            <div class="flex flex-col items-center justify-between text-center font-bold dark:text-white md:flex-row">
                ...
                <div>{{__('Need help? Visit the')}} <a href="{{ route('front.contact')}}" class="text-indigo-500 transition hover:text-indigo-900">{{__('Contact Us')}}</a></div>
            </div>
        </div>
    </div>
</footer>