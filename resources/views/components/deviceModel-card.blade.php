...
<div itemprop="itemListElement" itemscope itemtype="https://schema.org/Product">
    ...
    <div class="mb-5 bg-white rounded-lg shadow-2xl sm:w-full">
        <div class="relative text-left">
            <a href="{{ route('front.product', $deviceModel->slug) }}" class="flex justify-center" itemprop="url">
        ...
        <div class="px-2 pb-4 text-left">
            ...
            <a href="{{ route('front.product', $deviceModel->slug) }}">
            ...
            <div class="flex justify-center">
                ...
                {{-- href="{{ route('redirect', $deviceModel->url) }}" --}}
