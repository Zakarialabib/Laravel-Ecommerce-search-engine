    ...
    <div class="mb-5 bg-white rounded-lg shadow-2xl sm:w-full">
        <div class="relative text-left">
            <a href="{{ route('front.product', $product->slug) }}" class="flex justify-center" itemprop="url">
                ...
                @else
                    <img src="https://via.placeholder.com/1000x1000?text=Placeholder+Image" id="logoImg"
        ...
        <div class="px-2 pb-4 text-left">
            ...
            <div class="relative w-full inline-flex items-center justify-center gap-4">
                
                <a href="https://wa.me/" target="_blank"
                    class="ml-2  text-green-500 hover:text-blue-500  inline-flex"><span
                ...
                <a class="ml-2  text-red-500 hover:text-blue-500"
                    ...
                    <i class="fas fa-eye" class="h-5 w-5"></i>
                </a>
            </div>
